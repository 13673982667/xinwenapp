...
////			console.log(JSON.stringify(yidong));
////			console.log($('.photo-clip-rotateLayer>img')[0].style.transform);
////			console.log($('.photo-clip-rotateLayer').css('transform'))
////			$('#jiancai>img').css('transform',$('.photo-clip-rotateLayer').css('transform'))
// 			$('.lazy_cover,.lazy_tip').show();
//			clipImg();
//		});
	}
